...
<body>
    ...
    <div>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ProviderName="System.Data.OracleClient"
            ...
            DeleteCommand="DELETE FROM &quot;DATAWAREHOUSE_ATTRIBUTES_01&quot; WHERE &quot;RECORD_ID&quot; = :original_RECORD_ID AND ((&quot;PRIMARY_KEY&quot; = :original_PRIMARY_KEY) OR (&quot;PRIMARY_KEY&quot; IS NULL AND :original_PRIMARY_KEY IS NULL)) AND ((&quot;COLUMN_NAME&quot; = :original_COLUMN_NAME) OR (&quot;COLUMN_NAME&quot; IS NULL AND :original_COLUMN_NAME IS NULL)) AND ((&quot;DATA_TYPE&quot; = :original_DATA_TYPE) OR (&quot;DATA_TYPE&quot; IS NULL AND :original_DATA_TYPE IS NULL)) AND ((&quot;DEFINED_DATA&quot; = :original_DEFINED_DATA) OR (&quot;DEFINED_DATA&quot; IS NULL AND :original_DEFINED_DATA IS NULL)) AND ((&quot;COLUMN_PURPOSE&quot; = :original_COLUMN_PURPOSE) OR (&quot;COLUMN_PURPOSE&quot; IS NULL AND :original_COLUMN_PURPOSE IS NULL)) AND ((&quot;ADDITIONAL_COMMENTS&quot; = :original_ADDITIONAL_COMMENTS) OR (&quot;ADDITIONAL_COMMENTS&quot; IS NULL AND :original_ADDITIONAL_COMMENTS IS NULL))" 
            InsertCommand="INSERT INTO &quot;DATAWAREHOUSE_ATTRIBUTES_01&quot; (&quot;RECORD_ID&quot;, &quot;PRIMARY_KEY&quot;, &quot;COLUMN_NAME&quot;, &quot;DATA_TYPE&quot;, &quot;DEFINED_DATA&quot;, &quot;COLUMN_PURPOSE&quot;, &quot;ADDITIONAL_COMMENTS&quot;) VALUES (:RECORD_ID, :PRIMARY_KEY, :COLUMN_NAME, :DATA_TYPE, :DEFINED_DATA, :COLUMN_PURPOSE, :ADDITIONAL_COMMENTS)" 
            OldValuesParameterFormatString="original_{0}" 
            SelectCommand="SELECT &quot;RECORD_ID&quot;, &quot;PRIMARY_KEY&quot;, &quot;COLUMN_NAME&quot;, &quot;DATA_TYPE&quot;, &quot;DEFINED_DATA&quot;, &quot;COLUMN_PURPOSE&quot;, &quot;ADDITIONAL_COMMENTS&quot; FROM &quot;DATAWAREHOUSE_ATTRIBUTES_01&quot; WHERE (&quot;ENTITY_ID&quot; = :ENTITY_ID)" 
            UpdateCommand="UPDATE &quot;DATAWAREHOUSE_ATTRIBUTES_01&quot; SET &quot;PRIMARY_KEY&quot; = :PRIMARY_KEY, &quot;COLUMN_NAME&quot; = :COLUMN_NAME, &quot;DATA_TYPE&quot; = :DATA_TYPE, &quot;DEFINED_DATA&quot; = :DEFINED_DATA, &quot;COLUMN_PURPOSE&quot; = :COLUMN_PURPOSE, &quot;ADDITIONAL_COMMENTS&quot; = :ADDITIONAL_COMMENTS WHERE &quot;RECORD_ID&quot; = :original_RECORD_ID AND ((&quot;PRIMARY_KEY&quot; = :original_PRIMARY_KEY) OR (&quot;PRIMARY_KEY&quot; IS NULL AND :original_PRIMARY_KEY IS NULL)) AND ((&quot;COLUMN_NAME&quot; = :original_COLUMN_NAME) OR (&quot;COLUMN_NAME&quot; IS NULL AND :original_COLUMN_NAME IS NULL)) AND ((&quot;DATA_TYPE&quot; = :original_DATA_TYPE) OR (&quot;DATA_TYPE&quot; IS NULL AND :original_DATA_TYPE IS NULL)) AND ((&quot;DEFINED_DATA&quot; = :original_DEFINED_DATA) OR (&quot;DEFINED_DATA&quot; IS NULL AND :original_DEFINED_DATA IS NULL)) AND ((&quot;COLUMN_PURPOSE&quot; = :original_COLUMN_PURPOSE) OR (&quot;COLUMN_PURPOSE&quot; IS NULL AND :original_COLUMN_PURPOSE IS NULL)) AND ((&quot;ADDITIONAL_COMMENTS&quot; = :original_ADDITIONAL_COMMENTS) OR (&quot;ADDITIONAL_COMMENTS&quot; IS NULL AND :original_ADDITIONAL_COMMENTS IS NULL))">
            <SelectParameters>
